...
- Aktueller Clientstand: `app.js?v=20260702-3` mit `app-import-line-helpers.js?v=20260702-3`.
- Aktuelle Service-Worker-/Manifest-Version: `1.5.153`.
...
- Cache-Bump auf den aktuellen Clientstand `app.js?v=20260702-3` mit `app-import-line-helpers.js?v=20260702-3` und Service Worker `1.5.153` verhindert, dass bekannte Clients alte Importlogik behalten.
...
- Tablet-Assets und Service Worker sind im aktuellen Stand ueber Manifest/Service Worker `1.5.153` auszuliefern.
...
- Aktuelle Cache-/Manifest-Version: `1.5.153`.
...
Aktuelle Cache- und Manifest-Version: `1.5.153`.
