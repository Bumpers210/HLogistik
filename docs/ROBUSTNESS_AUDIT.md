...
- Aktueller Clientstand: `app.js?v=20260702-4` mit `app-import-line-helpers.js?v=20260702-3` und `app-import-diagnostics.js?v=20260702-4`.
- Aktuelle Service-Worker-/Manifest-Version: `1.5.154`.
...
- Cache-Bump auf den aktuellen Clientstand `app.js?v=20260702-4` mit `app-import-line-helpers.js?v=20260702-3`, `app-import-diagnostics.js?v=20260702-4` und Service Worker `1.5.154` verhindert, dass bekannte Clients alte Importlogik behalten.
...
- Tablet-Assets und Service Worker sind im aktuellen Stand ueber Manifest/Service Worker `1.5.154` auszuliefern.
...
- Aktuelle Cache-/Manifest-Version: `1.5.154`.
...
Aktuelle Cache- und Manifest-Version: `1.5.154`.
